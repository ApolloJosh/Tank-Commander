...
function screenTitle(){
  ...
  const topR=`${authEnabled()?`<a onclick="screenAccount()">${authState()?(authState().username||'Account'):'Account'}</a>`:''}<a onclick="screenWelcome()">Guide</a><a onclick="showGameRules()">Rules</a><span class="ver">v10.0</span>`;
  render(`
   <div class="tdash">
     ...
     <div class="tdash-grid">
       ...
       <section class="thero">
         ...
         <span class="stamp" style="margin:0 0 10px">Field Issue · Spec TC-100</span>
     ...
     <div class="tdash-foot"><span>Profile: GM Level ${plLevel()} · ${PROFILE.gamesPlayed||0} franchises played</span><span>Build 10.0.0</span></div>
   </div>
